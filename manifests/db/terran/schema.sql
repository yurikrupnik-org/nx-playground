...
-- MUST connect as a dedicated non-superuser role for these policies to take effect.
-- Local dev provides `terran_app` (see roles.sql); the `myuser` superuser bypasses RLS.
